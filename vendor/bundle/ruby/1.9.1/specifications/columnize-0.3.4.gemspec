...
```
  ...
  s.extra_rdoc_files = [%q{README}, %q{lib/columnize.rb}, %q{COPYING}]
  s.files = [%q{README}, %q{lib/columnize.rb}, %q{COPYING}]
  s.homepage = %q{https://github.com/rocky/columnize}
  s.licenses = [%q{Ruby}, %q{GPL2}]
  s.rdoc_options = [%q{--verbose}, %q{--main}, %q{README}, %q{--title}, %q{Columnize 0.3.4 Documentation}]
