authorization do
  role :admin do
    has_permission_on [:applications, :groups, :people, :ous, :roles, :classifications, :dialogs, :templates, :template_assignments, :entities], :to => [:index, :show, :new, :create, :edit, :update, :destroy, :delete]
    ...
    has_permission_on :person_manager_assignments, :to => [:create, :update, :delete]
