...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/general.yml', 'config/api_keys.yml', 'config/ldap.yml', 'config/newrelic.yml', 'sync/config/sysaid.yml', 'sync/config/active_directory.yml', 'sync/config/slack.yml')
